...
<head>
    <meta charset="UTF-8">
    <title>Carafat Group - Professional Accounting System</title>
...
<body class="bg-[#0f172a] text-gray-100 font-sans flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-[#090d16] border-r border-gray-800 flex flex-col shadow-2xl overflow-y-auto">
        <div class="p-6 text-center border-b border-gray-800 bg-[#06090f]">
            <h2 class="text-xl font-black tracking-wide text-emerald-400">🛒 Carafat Group</h2>
    ...
    <div class="flex-1 flex flex-col overflow-y-auto bg-[#0b1120]">
        <header class="bg-[#0f172a] border-b border-gray-800 px-8 py-4 flex justify-between items-center shadow-md">
            <div class="flex items-center gap-4">
                ...
                <!-- Badhanka Install-ka oo bilowgii qarsan kana dhex muuqda Header-ka -->
        ...
        <div class="p-8 space-y-6">
            ...
            <div id="welcome-message" class="bg-[#1e293b] border border-gray-800 p-16 rounded-2xl shadow-xl text-center text-gray-400">
                <h2 class="text-2xl font-bold text-white mb-2">Soo Dhawoow Carafat Group!</h2>
            ...
            <div id="section-sales" class="content-section hidden bg-[#1e293b] border border-gray-800 p-6 rounded-2xl shadow-lg">
                ...
                <form id="form-sales" action="/add_sale" method="POST" class="flex gap-3 hidden mt-4 mb-6 pt-4 border-t border-gray-800">
                    ...
                    <input type="text" name="description" placeholder="Faahfaahinta Iibka" class="border border-gray-700 p-2.5 rounded-xl w-1/3 text-sm bg-[#0f172a] text-white" required>
                    <input type="number" step="any" name="amount" placeholder="Wadarta Lacagta ($)" class="border border-gray-700 p-2.5 rounded-xl w-1/4 text-sm bg-[#0f172a] text-white" required>
                    <button type="submit" class="bg-purple-600 text-white px-6 py-2.5 rounded-xl text-xs font-semibold hover:bg-purple-700">Diiwaangeli</button>
                </form>
            </div>
